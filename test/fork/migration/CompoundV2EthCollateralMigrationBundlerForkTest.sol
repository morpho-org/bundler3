...
contract CompoundV2EthCollateralMigrationBundlerForkTest is MigrationForkTest {
    ...
    function testMigrateBorrowerWithPermit2(uint256 privateKey) public onlyEthereum {
        ...
        callbackBundle.push(_transferFrom2(C_ETH_V2, address(migrationBundler), cTokenBalance));
        callbackBundle.push(_compoundV2Redeem(C_ETH_V2, cTokenBalance, address(genericBundler1)));
        callbackBundle.push(_wrapNativeNoFunding(collateral, address(genericBundler1)));
