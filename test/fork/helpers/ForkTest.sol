...
abstract contract ForkTest is CommonTest, NetworkConfig {
    ...
    function setUp() public virtual override {
        ...
        if (isEq(config.network, "ethereum")) {
            ...
            generalAdapter1 = new GeneralAdapter1(address(initMulticall), address(morpho), getAddress("WETH"));
        }
        paraswapAdapter = new ParaswapAdapter(address(initMulticall), address(morpho), getAddress("AUGUSTUS_REGISTRY"));
