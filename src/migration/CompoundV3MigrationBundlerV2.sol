...
contract CompoundV3MigrationBundlerV2 is BaseBundler {
    /* CONSTRUCTOR */
    ...
    function compoundV3Repay(address instance, uint256 amount) external hubOnly {
        ...
        BundlerLib.approveMaxTo(asset, instance);
