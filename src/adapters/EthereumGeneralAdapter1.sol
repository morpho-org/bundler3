...
contract EthereumGeneralAdapter1 is GeneralAdapter1 {
    ...
    /// @param initMulticall The address of the initMulticall.
    ...
    ) GeneralAdapter1(initMulticall, morpho, weth) {
    ...
    function morphoWrapperWithdrawTo(address receiver, uint256 amount) external onlyInitMulticall {
    ...
    function wrapStEth(uint256 amount, address receiver) external onlyInitMulticall {
    ...
    /// @param receiver The account receiving the stETH tokens.
    function unwrapStEth(uint256 amount, address receiver) external onlyInitMulticall {
