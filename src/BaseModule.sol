...
contract BaseModule {
    ...
    /// @param amount The amount of native tokens to transfer. Pass max to transfer the module's balance.
    ...
    /// @param amount The amount of `token` to transfer. Pass max to transfer the module's balance.
